...
class BarronsSchema extends BaseSchema{
    constructor() {
        super();
    }
    ...
    getArticleSchema(){
        ...
        let subsection = getWindowUTagData("page_subsection") || getMetadata("page.subsection") || getMetadata("article.page") || "";
...
module.exports = new BarronsSchema;